...
path_mapping = {
    ...
    "Leader_issue_PDF_files_1056.parquet": os.path.join(
        image_folder, "converted/all_files_png_120/Leader_issue_PDF_files"
    ),
    "Monthly_Repository_issue_PDF_files_1056.parquet": os.path.join(
        image_folder, "converted/all_files_png_120/Monthly_Repository_issue_PDF_files"
    ),
    "Tomahawk_issue_PDF_files_1056.parquet": os.path.join(
        image_folder, "converted/all_files_png_120/Tomahawk_issue_PDF_files"
    ),
    "Publishers_Circular_issue_PDF_files_1056.parquet": os.path.join(
        image_folder, "converted/all_files_png_120/Publishers_Circular_issue_PDF_files"
    ),
    "Northern_Star_issue_PDF_files_2112.parquet": os.path.join(
        image_folder, "converted/all_files_png_200/Northern_Star_issue_PDF_files"
    ),
}

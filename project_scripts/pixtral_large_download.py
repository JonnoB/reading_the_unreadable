...
experiment_dir = "data/download_jobs/pixtral_large"
...
for dataset in ["NCSE", "BLN600"]:
    for deskew, max_ratio in experiments:
        ...
        results = download_processed_jobs(
            client=client,
            jobs_file=f"data/processed_jobs/pixtral_large/{file_name}.csv",
            output_dir=json_dir,
            log_file=f"data/download_jobs/pixtral_large/{file_name}_log.csv",
        )

"""
This is just a  quick modification of the experiment code to allow me to do Pixtral Large as well so I can compare performance with Pixtral 12B
...
BLN600_bbox["box_page_id"] = (
    "B0C1R0"  # This is just so the data is parsed properly when it is returned
)
...
experiments = list(zip([False], [1.5]))
...
for image_path, bbox_df, dataset_name in datasets:
    ...
    for deskew, max_ratio in experiments:
        ...
        output_file = f"data/processed_jobs/pixtral_large/{file_name}.csv"
